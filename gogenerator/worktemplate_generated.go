...
func init() {
	var err error
	if err = registerWorkTemplate("product_teams/feature_release:v1", wt00a1b44a5831c0a3acb14787b3fdd352); err != nil {
		panic(err)
	}
	if err = registerWorkTemplate("product_teams/some_other_usecase:v1", wt1e50a5b712f2155cfa93d564c0067eed); err != nil {
		panic(err)
	}
